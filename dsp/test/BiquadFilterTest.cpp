...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(
        ...
        FilterTestParams{1000.0f, BiquadFilter::Type::LOWPASS,
                         expectedGGainsLP},
        FilterTestParams{100.0f, BiquadFilter::Type::HIGHPASS,
                         expectedGGainsHP},
        FilterTestParams{200.0f, BiquadFilter::Type::HIGHPASS,
                         expectedGGainsHP},
        FilterTestParams{500.0, BiquadFilter::Type::HIGHPASS, expectedGGainsHP},
        FilterTestParams{1000.0, BiquadFilter::Type::HIGHPASS,
                         expectedGGainsHP}));
