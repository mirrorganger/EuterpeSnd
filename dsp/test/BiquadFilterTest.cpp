...
void testFilter(const BiquadFilter::FilterSettings &settings, const double freq, const double expectedGain,
    ...
    auto buffer = utilities::AudioBufferTools::makeSineWave(freq, settings.samplingFreq,
                                                            static_cast<uint32_t>(numSamples), settings.nChannels);
