...
expectDecreasingBuffer(std::vector(modulation.begin(),modulation.begin()+(stepsPerPeriod / 2)),MAX_ERROR);
expectIncreasingBuffer(std::vector(modulation.begin()+(stepsPerPeriod / 2),modulation.end()-1),MAX_ERROR);
